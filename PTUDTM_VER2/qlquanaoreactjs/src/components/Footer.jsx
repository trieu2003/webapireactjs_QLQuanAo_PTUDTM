...
function Footer() {
  return (
    <footer className="bg-black text-white py-44 mt-[50px] bg-cover bg-center" style={{ backgroundImage: "url('../public/images/footerbg.png')" }}>
      <div className="flex items-center justify-center space-x-3 mb-6"> {/* Sử dụng flex để căn logo và tên vào một dòng */}
        ...
        <span className="text-3xl font-bold">Shop Quần Áo</span> {/* Tên nằm cùng dòng với logo */}
      </div>
