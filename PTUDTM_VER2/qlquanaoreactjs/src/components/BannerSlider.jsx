        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className="bg-black bg-opacity-50 text-white w-full h-full flex flex-col justify-center items-start p-10 relative">
              ...
              <button 
              className="mt-4 bg-black px-6 py-2 text-lg rounded hover:bg-gray-700 hover:text-white"
              onClick={() => navigate(`/product/${slide.id}`)} // Sửa từ product.id thành slide.id
            >
              Xem chi tiết
            </button>
