...
namespace BE.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] LoginRequest request)
        {
            // Kiểm tra tài khoản người dùng
            var user = _context.TaiKhoanUsers
                .FirstOrDefault(u => u.TENTK == request.Username);
...
//        {
//            // Kiểm tra tài khoản người dùng
//            var user = _context.TaiKhoanUsers.FirstOrDefault(u => u.TENTK == request.Username);
...
//        public IActionResult ChangePassword([FromBody] ChangePasswordRequest request)
//        {
//            // Kiểm tra tài khoản người dùng theo tên đăng nhập
//            var user = _context.TaiKhoanUsers.FirstOrDefault(u => u.TENTK == request.Username);
...
//            bool isOldPasswordValid = BCrypt.Net.BCrypt.Verify(request.OldPassword, user.MATKHAU);
